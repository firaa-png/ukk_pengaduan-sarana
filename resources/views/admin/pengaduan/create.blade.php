...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Buat Pengaduan</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Buat Pengaduan</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('admin.pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pelapor" name="pelapor" value="{{ old('pelapor') }}" required>
                                        </div>
                                        <div class="form-group">
